...
<body>
	<div id="sureness" style="width: 100%;height: 100%;">
		<div class="container">
			 	<form
						action="${pageContext.request.contextPath}/beginPaper/paper/answer.do"
			...
			<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="row">
							<ul>
							<li role="presentation" class="alert alert-danger">剩余时间: <span
							id="time">${timeLeft}</span>分钟</li>
							</ul>
						</div>
				...
				<div class="col-sm-7">
						...
						<!--单选题 -->
						<div class="panel panel-info" id="part1">
						...
						<!-- 多选题 -->
						<div class="panel panel-info" id="part2">
							<div class="panel-heading">
								<h3 class="panel-title">第二部分 多选题
									共${paper.multChoiceNumber}题</h3>
							</div>
							<div class="panel-body">
								<c:forEach items="${paper.multChoiceList}" var="pro"
									varStatus="s">
									<div style="margin-left: 50px">
										<div class="quest">
											<code>第${s.count}题</code>
										...
										<div class="checkBox">
											<label><input type="checkBox" value="A"
												name="${pro.id}">A:${pro.optA }</label>
										</div>
										<div class="checkBox">
											<label><input type="checkBox" value="B"
						...
						<!--判断题 -->
						<div class="panel panel-info" id="part3">
							<div class="panel-heading">
						...
						<!-- 问答题 -->
						<div class="panel panel-info" id="part4">
							<div class="panel-heading">
