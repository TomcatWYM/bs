  ...
  <body>
    				...
    				<div class="panel panel-primary">
					  ...
					  <div class="panel-body">
					    ...
					    <div class="row">
					    	...
					    	<div class="col-sm-4">
					    		<a href='${pageContext.request.contextPath}/paperCart/paperCart.do' target="_blank" class="btn btn-lg btn-primary">进入试卷篮，生成试卷</a>
					    	</div>
					    </div>
    ...
    <script type="text/javascript">
    		...
    		$(function(){
    			...
    			//提交表单修改
    			$("#sub").click(function(){
     				$.post("../../problem/update/json.do",$("#form2").serialize(),function(date){
         				var mes = date.mes;
         				if(mes== 'success'){
         					alert("修改成功！");
         				}else{
